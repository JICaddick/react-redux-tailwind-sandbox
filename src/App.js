...
return (
	<div className=" bg-primary-cream h-screen w-screen flex justify-center items-center pb-12">
		<div className="border-2 rounded-xl mx-6 mt-12 h-full bg-white md:flex lg:flex">
			<img className="rounded-t-xl sm:h-5/6" src={imageFile} alt="perfume for ad" />
			<div className="">
				<div className="w-full h-1/6 text-neutral-dark-grayish-blue font-['Monserrat] pl-8 mt-6">
					P E R F U M E
				</div>
